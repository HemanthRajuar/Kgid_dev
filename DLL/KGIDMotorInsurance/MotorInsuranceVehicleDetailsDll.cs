...
namespace DLL.KGIDMotorInsurance
{
    public class MotorInsuranceVehicleDetailsDll : IMotorInsuranceVehicleDetailsDll
    {
        ...
        public string SaveMIVehicleDetailsDataExcel(VM_MotorInsuranceVehicleDetails vmVehicleDetails)
        {
            string result = string.Empty;
            try
            {
                    ...
                    SqlParameter[] sqlparam =
                {
                    ...
                    new SqlParameter("@ncb",vmVehicleDetails.mivd_ncb_id ),
                    new SqlParameter("@TypeofCoverID", vmVehicleDetails.mipd_type_of_cover_id),
                    new SqlParameter("@vehicle_fit_upto", vmVehicleDetails.mivd_vehicle_fit_upto),
                };
                    result = Convert.ToString(_Conn.ExecuteCmd(sqlparam, "sp_kgid_SaveMIRenewalVehicleDetails"));
                }
                else
                    ...
                    SqlParameter[] sqlparam1 =
              {
                    ...
                    new SqlParameter("@Vaahanidv", vmVehicleDetails.VehicleIDVAmount==null?"": vmVehicleDetails.VehicleIDVAmount),
                    new SqlParameter("@TypeofCoverID", vmVehicleDetails.mipd_type_of_cover_id),
                    new SqlParameter("@policy_number", vmVehicleDetails.p_mi_policy_number),
                    new SqlParameter("@from_date", vmVehicleDetails.p_mi_from_date),
                    new SqlParameter("@to_date", vmVehicleDetails.p_mi_to_date),
                    new SqlParameter("@vehicle_fit_upto", vmVehicleDetails.mivd_vehicle_fit_upto),
                    new SqlParameter("@tp_from_date", vmVehicleDetails.p_mi_tpfrom_date),
                    new SqlParameter("@tp_to_date", vmVehicleDetails.p_mi_tpto_date),
                    };
                    result = Convert.ToString(_Conn.ExecuteCmd(sqlparam1, "sp_kgid_SaveMIVehicleDetailsExcel"));
                }
        ...
        public VM_MotorInsuranceVehicleDetails GetMIRenewalVehicleDetails(long Empid, long RefID,long RenewalRefNo)
        {
            ...
            List<SelectListItem> subtypelist = null;
            List<SelectListItem> catlist = null;
            int vct_vehicle_category_type_id =Convert.ToInt32( dsVD.Tables[0].Rows[0]["vct_vehicle_category_type_id"]);
            //var VehicleCategoryTypeList1 = dsVD1.Tables[0].AsEnumerable().Select(dataRow => new SelectListItem()
            //{
            //    vct_vehicle_category_type_id=dataRow.Field<int>("vct_vehicle_category_type_id").ToString()
            //}).ToList();

            subtypelist = (from n in _db.tbl_vehicle_subtype_master
                           join b in _db.tbl_vehicle_category_master on n.vst_vehicle_subtype_id equals b.vc_vehicle_subtype_id
                           where b.vc_vehicle_category_id == vct_vehicle_category_type_id
                           select new SelectListItem { Value = n.vst_vehicle_subtype_id.ToString(), Text = n.vst_vehicle_subtype_desc }
                                             ).ToList();
        ...
        private VM_MotorInsuranceVehicleDetails BindVehiceDetails(DataSet dsVD)
        {
            if (dsVD.Tables[0].Rows.Count > 0)
            {
                ...
                _vehicleDetails.p_mi_policy_number = dsVD.Tables[0].Rows[0]["p_mi_policy_number"].ToString().ToUpper();
                ...
                _vehicleDetails.mivd_own_damage_value = Convert.ToString(dsVD.Tables[0].Rows[0]["mivd_own_damage_value"]) == "" ? 0 : Convert.ToDecimal(dsVD.Tables[0].Rows[0]["mivd_own_damage_value"]);
                ...
                _vehicleDetails.mivd_vehicle_category_type_id = (dsVD.Tables[0].Rows[0]["vct_vehicle_category_type_id"] == DBNull.Value ? 0 : Convert.ToInt32(dsVD.Tables[0].Rows[0]["vct_vehicle_category_type_id"]));
                _vehicleDetails.VehicleCategoryTypedesc = Convert.ToString(dsVD.Tables[0].Rows[0]["vct_vehicle_category_type_desc"]);
                _vehicleDetails.mivd_vehicle_class_id = (dsVD.Tables[0].Rows[0]["vcm_id"] == DBNull.Value ? 0 : Convert.ToInt32(dsVD.Tables[0].Rows[0]["vcm_id"]));
                ...
                _vehicleDetails.mivd_ncb_id = (dsVD.Tables[0].Rows[0]["mivd_no_claim_id"] == DBNull.Value) ? 0 : Convert.ToInt32(dsVD.Tables[0].Rows[0]["mivd_no_claim_id"]);
                _vehicleDetails.mivd_malus_value = (dsVD.Tables[0].Rows[0]["mivd_malus_value"] == DBNull.Value) ? 0 : Convert.ToInt32(dsVD.Tables[0].Rows[0]["mivd_malus_value"]);
                _vehicleDetails.vid_premium_short = (dsVD.Tables[0].Rows[0]["vid_premium_short"] == DBNull.Value) ? 0 : Convert.ToInt32(dsVD.Tables[0].Rows[0]["vid_premium_short"]);
                _vehicleDetails.vid_premium_excess = (dsVD.Tables[0].Rows[0]["vid_premium_excess"] == DBNull.Value) ? 0 : Convert.ToInt32(dsVD.Tables[0].Rows[0]["vid_premium_excess"]);
                _vehicleDetails.tp_to_date = (dsVD.Tables[0].Rows[0]["p_mi_tpto_date"] == DBNull.Value) ? "" : Convert.ToString(dsVD.Tables[0].Rows[0]["p_mi_tpto_date"]);
        ...
        //ICT
        public VM_MotorInsuranceIDVDetails IDVRenewalDetailsDll(long EmployeeCode, long refNo, long RenewalRefNo)
        {
            VM_MotorInsuranceIDVDetails objPD = new VM_MotorInsuranceIDVDetails();
            try
            {
                ...
                {
                new SqlParameter("@employee_id",EmployeeCode),
                new SqlParameter("@referenceid",refNo),
                new SqlParameter("@renewalreferenceid",RenewalRefNo),
                };
                dsPD = _Conn.ExeccuteDataset(sqlparam, "sp_kgid_selectMIIDVRenewalDetails");
                bool OtherData = false;
                if (dsPD.Tables.Count > 0)
                {
                    if (dsPD.Tables[0].Rows.Count > 0)
        ...
        public int SaveMIIDVDetailsDll(VM_MotorInsuranceIDVDetails objIDV)
        {
            ...
            if (objIDV.miidv_vaahanidvamount != null && objIDV.miidv_vaahanidvamount != "0")
            {
                UpdateIDVDeatils(objIDV.miidv_emp_id, objIDV.miidv_application_id, 1, objIDV.miidv_vaahanidvamount, true, true);
            }
            if (objIDV.miidv_insured_declared_value_amount != null && objIDV.miidv_insured_declared_value_amount != "0")
            {
                UpdateIDVDeatils(objIDV.miidv_emp_id, objIDV.miidv_application_id, 2, objIDV.miidv_insured_declared_value_amount, true, true);
            }
            if (objIDV.miidv_non_electrical_accessories_amount != null && objIDV.miidv_non_electrical_accessories_amount != "0")
            {
            ...
            SqlParameter[] sqlparam =
            {
             ...
             new SqlParameter("@premium_short",(objIDV.vid_premium_short==null?"0":objIDV.vid_premium_short)),
             new SqlParameter("@premium_excess",(objIDV.vid_premium_excess==null?"0":objIDV.vid_premium_excess))
            };
            result = Convert.ToInt32(_Conn.ExecuteCmd(sqlparam, "sp_kgid_insertMIIDVdetails"));
            return result;
        }
        ...
        public string SaveMIPreviousHistoryDetails(VM_MotorInsurancePreviousHistoryDetails vmPreviousHistoryDetails)
        {
            ...
            try
            {
             ...
             new SqlParameter("@Malus_val",vmPreviousHistoryDetails.previous_vehicle_malus),
             new SqlParameter("@NCB_val",vmPreviousHistoryDetails.previous_vehicle_ncb),
             new SqlParameter("@PageType",(vmPreviousHistoryDetails.mivd_pagetype==null?"":vmPreviousHistoryDetails.mivd_pagetype))
            };
                result = Convert.ToString(_Conn.ExecuteCmd(sqlparam, "sp_kgid_saveprevioushistorydetails_new"));
            }
            catch (Exception ex)
            {
        ...
        public PolicyPremiumDetailMI selectPaymentDetailsMI(string pagetype, long empId, int applicationId)
        {
            ...
            if (details.Tables != null && details.Tables.Count > 0 && details.Tables[0].Rows.Count > 0)
            {
                obj.RefNo= details.Tables[0].Rows[0]["cd_challan_ref_no"].ToString();
                obj.HOA = details.Tables[0].Rows[0]["cd_hoa_code"].ToString();
                obj.ADDOCode = details.Tables[0].Rows[0]["cd_agency_ddo_id"].ToString();
        ...
        public string GetDateOfRisk_bll(string ReferanceNo)
        {
            ...
            try
            {
                ...
                SqlParameter[] sqlparam =
                {
                    new SqlParameter("@ReferanceNo",ReferanceNo)
                };
                dsMBList = _Conn.ExeccuteDataset(sqlparam, "sp_kgid_GetDateOfRisk");
                if (dsMBList.Tables[0].Rows.Count > 0)
                {
                    message = Convert.ToString(dsMBList.Tables[0].Rows[0]["p_mi_to_date"]);
                }
                return message; 
            }
            catch (Exception ex)
        ...
        //Transfer Vehicle
        public string CheckTransferVehicleNo(string vehicleNo)
        {
            SqlParameter[] parms = {
            new SqlParameter("@vehicleNo",vehicleNo)
            };

            return _Conn.ExecuteCmd(parms, "sp_CheckTransferVehicleNoValid");
        }
        public VM_MotorInsuranceVehicleTransfer VehicleDetailsForTransferDll(string vehicleNo)
        {
            VM_MotorInsuranceVehicleTransfer VehicleDetails = new VM_MotorInsuranceVehicleTransfer();
            DataSet dsPD = new DataSet();
            ...
            dsPD = _Conn.ExeccuteDataset(parms, "sp_getVehicleDetailsForTransfer");
            if (dsPD.Tables.Count == 1)
            {
                if (dsPD.Tables[0].Rows.Count > 0)
                {
                    VehicleDetails.vehicle_details_id = Convert.ToInt32(dsPD.Tables[0].Rows[0]["mivd_vehicle_details_id"]);
                    VehicleDetails.vehicle_application_id = Convert.ToInt64(dsPD.Tables[0].Rows[0]["p_mi_application_id"]);
                    VehicleDetails.vehicle_registration_no = Convert.ToString(dsPD.Tables[0].Rows[0]["mivd_registration_no"]);
                    VehicleDetails.vehicle_chassis_no = Convert.ToString(dsPD.Tables[0].Rows[0]["mivd_chasis_no"]);

                    VehicleDetails.vehicle_registration_no = Convert.ToString(dsPD.Tables[0].Rows[0]["mivd_registration_no"]);
                    VehicleDetails.mivd_vehicle_type = Convert.ToInt32(dsPD.Tables[0].Rows[0]["mivd_vehicle_type"]);
                    VehicleDetails.vehicletypename = Convert.ToString(dsPD.Tables[0].Rows[0]["vehicletypename"]);
                    VehicleDetails.mivd_vehicle_subtype = Convert.ToInt32(dsPD.Tables[0].Rows[0]["mivd_vehicle_subtype"]);
                    VehicleDetails.vehiclesubtypename = Convert.ToString(dsPD.Tables[0].Rows[0]["vehiclesubtypename"]);
                    VehicleDetails.mivd_vehicle_category = Convert.ToInt32(dsPD.Tables[0].Rows[0]["mivd_vehicle_category"]);
                    VehicleDetails.vehiclecategoryname = Convert.ToString(dsPD.Tables[0].Rows[0]["vehiclecategoryname"]);
                    VehicleDetails.mivd_class_id = Convert.ToInt32(dsPD.Tables[0].Rows[0]["mivd_class_id"]);
                    VehicleDetails.vehicleclassname = Convert.ToString(dsPD.Tables[0].Rows[0]["vehicleclassname"]);

                    VehicleDetails.p_mi_policy_number = Convert.ToString(dsPD.Tables[0].Rows[0]["p_mi_policy_number"]);
                    VehicleDetails.policy_from_date = Convert.ToString(dsPD.Tables[0].Rows[0]["p_mi_from_date"]);
                    VehicleDetails.policy_to_date = Convert.ToString(dsPD.Tables[0].Rows[0]["p_mi_to_date"]);

                    VehicleDetails.ddo_code = Convert.ToString(dsPD.Tables[0].Rows[0]["dm_ddo_code"]);
                    VehicleDetails.ddo_office_name = Convert.ToString(dsPD.Tables[0].Rows[0]["dm_ddo_office"]);
                    
                    //VehicleDetails.status = Convert.ToString(dsPD.Tables[0].Rows[0]["status"]);
        ...
        public VM_DDOVerificationDetailsMI GetChallanDetailsDll(string ChallanNo, long EmpID, int Category)
        {
            VM_DDOVerificationDetailsMI verificationDetails = new VM_DDOVerificationDetailsMI();
            DataSet dsCD = new DataSet();
            ...
            if (dsCD.Tables.Count > 0)
            {
                if (dsCD.Tables[1].Rows.Count > 0)
                {
                    ...
                    verificationDetails.BillSector = Convert.ToString(dsCD.Tables[0].Rows[0]["Bill_Sector"]);
                }
            }
            return verificationDetails;
        }
        ...
        {
            long emp = Convert.ToInt64(EmpId);
            ...
            if (dsPS.Tables[0].Rows.Count > 0)
            {
                ...
                var e = (from ed in _db.tbl_employee_basic_details
                         join cd in _db.tbl_challan_details.AsNoTracking().Where(m => m.cd_active_status == 1 && m.cd_module_id == 4 && m.cd_payment_type == "TTR") on ed.employee_id equals emp
                         ...
                         join csm in _db.tbl_challan_status_master.AsNoTracking().Where(a => a.csm_active_status == 1 && a.csm_status == "Draft Accepted in DDO office") on cs.cs_status equals csm.csm_status_id
            ...
            if (dsPS.Tables[1].Rows.Count > 0)
            {
                ...
                //}).ToList();
                var e = (from ed in _db.tbl_employee_basic_details
                         join cd in _db.tbl_challan_details.AsNoTracking().Where(m => m.cd_active_status == 1 && m.cd_module_id == 4 && m.cd_payment_type == "TTR" && m.cd_ack_status_flag== "fail") on ed.employee_id equals emp
                         join cs in _db.tbl_challan_status.AsNoTracking().Where(p => p.cs_active_status == 1 && p.cs_service_response == "MB") on cd.cd_challan_id equals cs.cs_challan_id
                         join csm in _db.tbl_challan_status_master.AsNoTracking().Where(a => a.csm_active_status == 1 && a.csm_status == "Rejection of the bill in DDO office" || a.csm_status == "Rejection of the bill in Treasury") on cs.cs_status equals csm.csm_status_id
            ...
            if (dsPS.Tables[2].Rows.Count > 0)
            {
                ...
                var e = (from ed in _db.tbl_employee_basic_details
                         join cd in _db.tbl_challan_details.AsNoTracking().Where(m => m.cd_active_status == 1 && m.cd_module_id == 4 && m.cd_payment_type == "TTR"  ) on ed.employee_id equals emp
                         join cs in _db.tbl_challan_status.AsNoTracking().Where(p => p.cs_active_status == 1 && p.cs_service_response == "MB") on cd.cd_challan_id equals cs.cs_challan_id
                         join csm in _db.tbl_challan_status_master.AsNoTracking().Where(a => a.csm_active_status == 1 && a.csm_status == "Approval of the bill in Treasury") on cs.cs_status equals csm.csm_status_id
            ...
            if (dsPS.Tables[3].Rows.Count > 0)
            {
                ...
                obj.listChallanPendingAtDDO = e;
            }
            return obj;
        }

        // ict 18-11-2021
        public VM_MotorInsurancePaymentStatus MotorInsuranceRenewalPaymentStatusDll(string EmpId)
        {
            VM_MotorInsurancePaymentStatus obj = new VM_MotorInsurancePaymentStatus();
            DataSet dsPS = new DataSet();
            ...
            dsPS = _Conn.ExeccuteDataset(parms, "sp_get_motorinsurance_renewal_challan_status");
            if (dsPS.Tables[0].Rows.Count > 0)
            {
                var list = dsPS.Tables[0].AsEnumerable().Select(dataRow => new VM_MotorInsurancePaymentStatus
                {
        ...
        public string InsertotcChallanDetailsDll(long EmpID, int Category, string Applications, int ChallanAmount, string sanno, DateTime sandate, string voucherno, string hoa, string ddocode, string Type)
        {
            string result = string.Empty;
            try
            {
        ...
        public VM_DDOVerificationDetailsMI GetotcChallanDetailsDll(string ChallanNo, long EmpID, int Category)
        {
            VM_DDOVerificationDetailsMI verificationDetails = new VM_DDOVerificationDetailsMI();
            DataSet dsCD = new DataSet();
            int emp = (int)EmpID;
            ...
            dsCD = _Conn.ExeccuteDataset(sqlparam, "sp_kgid_GetChallandetailsOTC");
            ...
            if (dsCD.Tables.Count > 0)
            {
                if (dsCD.Tables[1].Rows.Count > 0)
                {
                    ...
                    verificationDetails.DEPTCODE = Convert.ToString(dsCD.Tables[0].Rows[0]["DEPTCODE"]);
                    verificationDetails.DEPTPRPSID = Convert.ToString(dsCD.Tables[0].Rows[0]["DEPTPRPSID"]);
        ...
        public string UpdateRCT0335Ack(string ChallanRefno, string statusflag, string statusMessage)
        {
            string result = string.Empty;
            try
            {
                ...
                result = Convert.ToString(_Conn.ExecuteCmd(sqlparam, "Sp_KGID_Update_RCT033_Ack"));
        ...
        public VM_MotorInsurancePaymentStatus MotorInsuranceotcPaymentStatusDll(string EmpId)
        {
            VM_MotorInsurancePaymentStatus obj = new VM_MotorInsurancePaymentStatus();
            long emd = long.Parse(EmpId);
            DataSet dsPS = new DataSet();
            ...
            dsPS = _Conn.ExeccuteDataset(parms, "sp_get_motorinsurance_otc_challan_status");
            //if (dsPS.Tables[0].Rows.Count > 0)
            //{
            //    var list = dsPS.Tables[0].AsEnumerable().Select(dataRow => new VM_MotorInsurancePaymentStatus
            //    {
        ...
        //ICT 10-Nov-2021
        public long SaveMBChallanStatusDll(VM_PaymentDetails objPaymentDetails)
        {
            long result = 0;
            try
            {
        ...
        //ICT 18-Nov-2021
        public string InsertRenewalChallanDetailsDll(long EmpID, int Category, string Applications, int ChallanAmount, string sanno, DateTime sandate, string voucherno, string hoa, string ddocode, string Type)
        {
            string result = string.Empty;
            try
            {
                SqlParameter[] sqlparam =
                  {
                    new SqlParameter("@Purposeid",2),
                    new SqlParameter("@Subpurposeid",14),
                    new SqlParameter("@Amount",ChallanAmount),
                    new SqlParameter("@AppID",Applications),
                    new SqlParameter("@Empid",EmpID),
                    new SqlParameter("@ChallanRefNo",""),
        ...
        public VM_DDOVerificationDetailsMI GetRenewalChallanDetailsDll(string ChallanNo, long EmpID)
        {
            VM_DDOVerificationDetailsMI verificationDetails = new VM_DDOVerificationDetailsMI();
            DataSet dsCD = new DataSet();
            ...
            dsCD = _Conn.ExeccuteDataset(sqlparam, "sp_kgid_GetRenewalChallandetails");
        ...
        public string InsertRenewalotcChallanDetailsDll(long EmpID, int Category, string Applications, int ChallanAmount, string sanno, DateTime sandate, string voucherno, string hoa, string ddocode, string Type)
        {
            string result = string.Empty;
            try
            {
        ...
        public VM_DDOVerificationDetailsMI GetotcRenewalChallanDetailsDll(string ChallanNo, long EmpID)
        {
            VM_DDOVerificationDetailsMI verificationDetails = new VM_DDOVerificationDetailsMI();
            DataSet dsCD = new DataSet();
            ...
            dsCD = _Conn.ExeccuteDataset(sqlparam, "sp_kgid_GetRenewalChallandetailsOTC");
