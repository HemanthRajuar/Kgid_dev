...
namespace DLL.DBConnection
{
    public class DbConnectionKGID : DbContext
    {
        ...
        public DbSet<tbl_challan_status> tbl_challan_status { get; set; }
             ...
             public DbSet<tbl_challan_status_master> tbl_challan_status_master { get; set; }
        ...
        public DbSet<tbl_assign_application> tbl_assign_application { get; set; }
 ...
 //Update Application Mapping
        public DbSet<tbl_application_status_master> tbl_application_status_master { get; set; }
        public DbSet<tbl_role_mapping> tbl_role_mapping { get; set; }


        // GroupInsurance -- Devika
        public DbSet<tbl_GIS_application_details> tbl_GIS_application_details { get; set; }
        public DbSet<tbl_GIS_nominee_details> tbl_GIS_nominee_details { get; set; }
        public DbSet<tbl_GIS_Subcription_Master> tbl_GIS_Subcription_Master { get; set; }
        public DbSet<tbl_GIS_challan_details> tbl_GIS_challan_details { get; set; }
        public DbSet<tbl_GIS_challan_status> tbl_GIS_challan_status { get; set; }
        public DbSet<tbl_GIS_Subcription_details> tbl_GIS_Subcription_details { get; set; }
        public DbSet<tbl_GIS_application_workflow_details> tbl_GIS_application_workflow_details { get; set; }
        public DbSet<tbl_GIS_upload_employeeform> tbl_GIS_upload_employeeform { get; set; }
        public DbSet<tbl_GIS_NomineeReq_workflow_details> tbl_GIS_NomineeReq_workflow_details { get; set; }

        public DbSet<tbl_GIS_NR_upload_form> tbl_GIS_NR_upload_form { get; set; }
      //  public DbSet<tbl_application_status_master> tbl_application_status_master { get; set; }

        public DbSet<tbl_ddo_dio_master> tbl_ddo_dio_master { get; set; }
       // public DbSet<tbl_assign_application> tbl_assign_application { get; set; }

        public DbSet<tbl_GIS_family_relation_master> tbl_GIS_family_relation_master { get; set; }
        public DbSet<tbl_GIS_family_type_master> tbl_GIS_family_type_master { get; set; }
        public DbSet<tbl_claim_type_master> tbl_claim_type_master { get; set; }
        public DbSet<tbl_claim_subtype> tbl_claim_subtype { get; set; }

        public DbSet<TBL_GIS_FUND_MONTHWISE> TBL_GIS_FUND_MONTHWISE { get; set; }
        public DbSet<tbl_year_master> tbl_year_master { get; set; }

        public DbSet<tbl_GIS_NomineeBankDetails> tbl_GIS_NomineeBankDetails { get; set; }

        public DbSet<tbl_ErrorLog> tbl_ErrorLog { get; set; }  //KGID_Master

        //public DbSet<tbl_challan_status_master> tbl_challan_status_master { get; set; }  //KGID_Master
