...
namespace DLL.DBConnection
{
    public class Common_Connection
    {
        ...
        //ICT
        public DataSet ExeccuteDataset(string qry)
        {
            DataSet ds = new DataSet();
            SqlConnection con = new SqlConnection();
            try
            ...
            {
                Logger.LogMessage(TracingLevel.INFO, "ExecuteCmd-SP->" + qry + "-Errors->" + ex.Message);
            }
            finally
            {
                con.Close();
        ...
        public int ExeccuteNonQuery(string qry)
        {
            DataSet ds = new DataSet();
            SqlConnection con = new SqlConnection();
            try
