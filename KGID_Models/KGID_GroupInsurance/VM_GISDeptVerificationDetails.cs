...
{
   public  class VM_GISDeptVerificationDetails
    {
        public VM_GISDeptVerificationDetails()
        {
            WorkFlowDetails = new List<VM_GISWorkflowDetail>();  // new List<VM_WorkflowDetail>();
   ...
   public int VerificationId { get; set; }
    ...
    public decimal? SumAssured { get; set; }
        ...
        public string ApplnUploaddocPath { get; set; }
        public string ApplnUploaddocType { get; set; }

        //public string AppldocPath { get; set; }
        //public string UploaddocType { get; set; }

        public string Form6UploaddocPath { get; set; }
        public string Form6UploaddocType { get; set; }

        public string Form7UploaddocPath { get; set; }
        public string Form7UploaddocType { get; set; }

      

        //

        public IList<VM_GISWorkflowDetail> WorkFlowDetails { get; set; }
