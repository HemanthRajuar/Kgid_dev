...
namespace KGID_Models.KGIDMotorInsurance
{
    public class VM_MotorInsuranceVehicleDetails
    {
        ...
        public DateTime? mivd_vehicle_fit_upto { get; set; }
        public decimal? vid_premium_short { get; set; }
        public decimal? vid_premium_excess { get; set; }
    ...
    //Vehicle Transsfer
    public class VM_MotorInsuranceVehicleTransfer
    {
        public VM_MotorInsuranceVehicleTransfer()
        {
            listVehicleDetails = new List<VM_VehicleDetailsForTransfer>();
        }
        public List<VM_VehicleDetailsForTransfer> listVehicleDetails { get; set; }
        ...
        public string ddo_office_name { get; set; }
        ...
        public List<SelectListItem> DDOCodeList { get; set; }
        public List<SelectListItem> EmployeeList { get; set; }
        public string TransferDDOOfficeName { get; set; }
        public string TransferDDOCode { get; set; }
        public string TransferDDOAddress { get; set; }
        public long TransferKgidNumber { get; set; }
        public long TransferEmpID { get; set; }
        public int reasonID { get; set; }
        public string reasonDesc { get; set; }
        public List<SelectListItem> TransferReasonList { get; set; }
           
    }
    public class VM_VehicleDetailsForTransfer
    {
        public long App_Proposer_ID { get; set; }
        public long MI_App_Reference_ID { get; set; }
        public int vehicle_details_id { get; set; }
