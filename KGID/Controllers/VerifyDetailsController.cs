...
namespace KGID.Controllers
{
    ...
    public class VerifyDetailsController : Controller
    {
        ...
        [Route("kgid-ddo-verification-for-ptd")]       
        public ActionResult TrackProposalForAdmin(long empId = 0, long applicationId = 0)
        {
            if (Session["UID"] != null)
            {
                ...
                {
                    return RedirectToAction("ProposerTrackDetails-1");
                }
                return View(verificationDetails);
            }
            else
...
/////Verification Details
        ...
        private string FillFormMB(VM_MB_Bond_Details _MBBond, string PolicyNumber)
        {
            ...
            {//Basic Details
                ...
                fields.SetField("EngineNo", _MBBond.Engine_no == null ? "" : _MBBond.Engine_no.ToString());
