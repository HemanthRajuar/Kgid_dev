    ...
    public class KIIController : Controller
    {
        ...
        public void IndexPost(VM_PaymentDetails objPaymentDetails)//KIIRequest request
        {
            ...
            using (var client = new HttpClient())
            {
                    ...
                    //client.BaseAddress = new Uri("http://10.96.158.108:5050/kgid/SignXmlData/");
                    ...
                    /////////
                    ///
                    Logger.LogMessage(TracingLevel.INFO, "RCT33-byteContent" + byteContent);
                    ...
                    Logger.LogMessage(TracingLevel.INFO, "RCT33-SignedResultData" + SignedresultContent);
                }
