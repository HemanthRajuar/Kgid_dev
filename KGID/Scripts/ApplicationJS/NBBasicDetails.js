$(document).ready(function () {
    ...
    if ($(".rd-btn-mstatus:checked").val() === "True") {
        ...
        $("#rbtnMarried").prop("checked", true);`1`
        $("#rbtnUnmarried").prop("checked", false);
...
$(".rd-btn-mstatus").change(function () {
    if ($(this).val() === "True") {
        ...
        if ($("#txtSpouseName").val() != "" && $("#txtSpouseNameKN").val() != "") {
           /* alert("SDDSFSDFsdfsd");*/
            $("#divMarriedOptions").divunmarried();
...
function ValidateBasicDetails() {
    ...
    if (cursorempname == 1) {
        ...
        $("#txtSpouseNameKN").focus().val('').val(value);
    }
