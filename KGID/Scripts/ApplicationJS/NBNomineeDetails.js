...
$("#txtNomineeAge").on("change", function () {
    ...
    if (NAge <= 18 && memberName === "Other") {
        
        $("#txtGuardianName").val("");
        $("#ddlGuardianRelation").val("");
        $("#txtGuardianName").attr("disabled", false);
    ...
    if ($("#ddlNomineeRelation").val() != "") {
        if (memberName === "Other") {
            if (alldead == true || isOrphan === "True") {
                ...
                //$("#txtNomineeAge").removeAttr('disabled');
                $("#txtNomineeAge").attr("disabled", "false");
            ...
            $("#ddlGuardianRelation").removeAttr("readonly", "readonly");
...
function validateEditNomineeFields() {
    ...
    if ((isOrphan === "True" && drpdwnRelation === 'Other') || (alldead == true && drpdwnRelation === "Other")) {
        if (txtAge < 18) {
