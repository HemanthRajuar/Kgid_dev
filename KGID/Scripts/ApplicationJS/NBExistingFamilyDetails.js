...
$('#ddlRelation').change(function (e) {
    ...
    if (relation == "None") {
        ...
        $("#txtDAge").val("").attr("disabled", true);
        ...
        $("#txtDAge").val("").removeAttr("disabled");
    ...
    if (relation === "Father") {
        if ($('#txtFatherName').val() != "") {
            $('#txtMemberName').val($('#txtFatherName').val());
    ...
    if (relation === "Spouse") {
        ...
        else if (isFatherAdded == 0 && isOrphan != "True" && $('#txtFatherName').val() != '') {
            $('#ddlRelation').val("");
            $("#errMember").text("Please add father before adding other family members");
            $("#errMember").removeAttr("hidden");
        }
        else if (isMotherAdded == 0 && isOrphan != "True" && $('#txtFatherName').val() != '') {
            $('#ddlRelation').val("");
...
function SaveFamilyMember(savetype) {
    ...
    if (!err) {
        ...
        var isOrphan = $("#hdnIsOrphan").val();
        var isOrphanlength = $(".rd-btn-orphan:checked").length;
        //   alert(isMarried); alert(isOrphanlength);
        if (isMarried === "True" || (isOrphanlength > 0 && isOrphan !== "True")) {
            ...
            var viewModel = {
                ...
                ApplicationId: $("#spnBReferanceNo").val(),
