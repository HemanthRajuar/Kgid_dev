...
{    
  ...
  //  var relation = $("#ddlEditNomineeList option:contains('" + relation + "')").attr("selected", "selected");
   ...
   // $("#ddlEditNomineeList").text(relationName);
    ...
    //alert(filepath);
  // '<%Session["filepathA"] = "' + filepath + '"; %>';
  //  sessionStorage.setItem("filepathA", filepath);
   // alert(Session["filepathA"])
    //session.set("filepathA", filepath);
   // alert(session.get("filepathA"))
    //$.session.set('filepathA', filepath);
  //  '@ViewBag.mm' = filepath;
   ...
   // CheckDuplicateName();
    ...
    {      
       // var valresult = validateNomineeFields();
        ...
        {  alertify.alert('Memeber already Added').setHeader("Warning!!!");  }
    }
    else { 
...
function CheckDuplicateName()
{
    ...
    tbl.rows().every(function ()
    {
        ...
        if (data[4] == $("#ddlNomineeList option:selected").text() && data[1] == $("#txtNomineeName").val())
        { return result = true;}
...
function CheckDuplicateNameUpdate() {
    ...
    tbl.rows().every(function () {
        ...
        if (data[4] == $("#ddlEditNomineeList option:selected").text() && data[1] == $("#txtEditNomineeName").val() && $("#hdnId").val() != data[0]) { return result = true; }
