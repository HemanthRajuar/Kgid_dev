...
$("#btnSubmit").click(function (e) {
    ...
    /* if ($('#chkAppD').prop('checked') && ($('#chkPaidD').prop('checked')) && ($('#chkSignedD').prop('checked'))) {*/
    if ($('#chkPD').prop('checked') && ($('#chkFamNomD').prop('checked')) && ($('#chkPAD').prop('checked')) && ($('#chkAppD').prop('checked')) && ($('#chkSignedD').prop('checked')) && ($('#chkPaidD').prop('checked'))) {
    ...
    {
        if ($('#chkPD').prop('checked') == false) { $("#errchkPD").removeAttr('hidden'); }
        if ($('#chkFamNomD').prop('checked') == false) { $("#errchkFamNomD").removeAttr('hidden'); }
        if ($('#chkPAD').prop('checked') == false) { $("#errchkPAD").removeAttr('hidden'); }
        if ($('#chkAppD').prop('checked') == false) { $("#errchkAppD").removeAttr('hidden'); }
        if ($('#chkSignedD').prop('checked') == false) { $("#errchkSignedD").removeAttr('hidden'); }
        if ($('#chkPaidD').prop('checked') == false) { $("#errchkPaidD").removeAttr('hidden'); }
    }
...
$('#chkPD').change(function () {
    $("#errchkPD").attr("hidden", true);;
});

$('#chkPAD').change(function () {
    $("#errchkPAD").attr("hidden", true);;
});

$('#chkSignedD').change(function () {
    $("#errchkSignedD").attr("hidden", true);;
});

$('#chkFamNomD').change(function () {
    $("#errchkFamNomD").attr("hidden", true);;
});

$('#chkPaidD').change(function () {
    $("#errchkPaidD").attr("hidden", true);;
});
...
$('#rbtnForwardToemp').change(function () {
    $("#errrbtn").attr("hidden", true);;
});

$('#chkPayD').change(function () {
    $("#errchkPAD").attr("hidden", true);;
});
