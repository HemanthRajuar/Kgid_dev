   ...
   public interface ITicketingToolBLL
    {
        ...
        #region FileUpload
        string FileUploadbll(HttpPostedFileBase fileBase, int uploadType, int masterTable);
        #endregion

        #region Vehical Mapping To DDO
        List<VehicalMappingToDDO> GetVehicalDetailsUsingVehicalNumber_bll(string ddocode);
        DataSet GetDdoCode_bll(string ddocode);
        string SaveDDoMapping_bll(List<VehicalMappingToDDO> VehicalMappingToDDO);
        #endregion
    }
}
