...
namespace BLL.NewEmployeeBLL
{
    public class NBApplicationBll : INBApplicationBll
    {
        ...
        //    return referanceNo;
        //}
        public string SaveNBBasicBll(VM_BasicDetails basicDetails)
        {
            string referanceNo = _INBApplicationdll.SaveNBBasic(basicDetails);
            return referanceNo;
        }
        ...
        {
            return _INBApplicationdll.GetApplicationMappingDetails(ApplicationRefnum);
        }

        public List<VM_ApplicationDetail> GetemployeeDetailsBasedOfKGIDNo(long KGIDno)
        {
            return _INBApplicationdll.GetemployeeDetailsBasedOfKGIDNo(KGIDno);
        }

        public async Task<bool> UpdateAssignedTo(long EmployeeId, long kawt_workflow_id, int kawt_application_status)
        {
            return await _INBApplicationdll.UpdateAssignedTo(EmployeeId, kawt_workflow_id, kawt_application_status);
        }

        public IEnumerable<tbl_verification_details> ExistingKGIDDetailsDll(long? policyno)
        {
            return _INBApplicationdll.ExistingKGIDDetailsDll(policyno);
