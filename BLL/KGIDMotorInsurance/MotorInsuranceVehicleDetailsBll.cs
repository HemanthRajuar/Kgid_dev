  ...
  public  class MotorInsuranceVehicleDetailsBll:IMotorInsuranceVehicleDetailsBll
    {
        ...
        public VM_MotorInsuranceIDVDetails IDVRenewalDetailsBll(long EmployeeCode, long refNo, long RenewalRefNo)
        {
            var x = _IMotorInsuranceVehicleDetailsDll.IDVRenewalDetailsDll(EmployeeCode, refNo,RenewalRefNo);
            return x;
        }
      ...
      public  string  SaveMIPreviousHistoryDetails(VM_MotorInsurancePreviousHistoryDetails vmPreviousHistoryDetails)
        ...
        {
            return _IMotorInsuranceVehicleDetailsDll.GetDateOfRisk_bll(ReferanceNo);
        }
        //Save MB Bond
        ...
        {
            return _IMotorInsuranceVehicleDetailsDll.CheckTransferVehicleNo(vehicleNo);
        }
        public VM_MotorInsuranceVehicleTransfer VehicleDetailsForTransfer(string vehicleNo)
        {
            return _IMotorInsuranceVehicleDetailsDll.VehicleDetailsForTransferDll(vehicleNo);
        }
        ...
        public VM_DDOVerificationDetailsMI GetChallanDetailsBll(string ChallanNo, long EmpID, int Category)
        {
            return _IMotorInsuranceVehicleDetailsDll.GetChallanDetailsDll(ChallanNo, EmpID, Category);
        }
        //ict 30-10-2021
        //public string InsertotcChallanDetailsBll(long EmpID, int Category, string RefNos, int ChallanAmount, string sanno, DateTime sandate, string voucherno, string hoa, string ddocode, string Type)
        //{
        //    return _IMotorInsuranceVehicleDetailsDll.InsertotcChallanDetailsDll(EmpID, Category, RefNos, ChallanAmount, sanno, sandate, voucherno, hoa, ddocode, Type);
        //}

        //public VM_DDOVerificationDetailsMI GetotcChallanDetailsBll(string ChallanNo, long EmpID)
        //{
        //    return _IMotorInsuranceVehicleDetailsDll.GetotcChallanDetailsDll(ChallanNo, EmpID);
        //}
        //public string UpdateRCT0335AckBll(string ChallanRefno, string statusflag, string statusMessage)
        //{
        //    return _IMotorInsuranceVehicleDetailsDll.UpdateRCT0335Ack(ChallanRefno, statusflag, statusMessage);
        //}

        //public VM_MotorInsurancePaymentStatus MotorInsuranceotcPaymentStatusBll(string EmpId)
        //{
        //    return _IMotorInsuranceVehicleDetailsDll.MotorInsuranceotcPaymentStatusDll(EmpId);
        //}

        //public long SaveMBChallanStatusDll(VM_PaymentDetails objPaymentDetails)
        //{
        //    var result = _IMotorInsuranceVehicleDetailsDll.SaveMBChallanStatusDll(objPaymentDetails);
        //    return result;
        //}
        ...
        public VM_DDOVerificationDetailsMI GetotcChallanDetailsBll(string ChallanNo, long EmpID, int Category)
        {
            return _IMotorInsuranceVehicleDetailsDll.GetotcChallanDetailsDll(ChallanNo, EmpID, Category);
        }
        public string UpdateRCT0335AckBll(string ChallanRefno, string statusflag, string statusMessage)
        {
            return _IMotorInsuranceVehicleDetailsDll.UpdateRCT0335Ack(ChallanRefno, statusflag, statusMessage);
        ...
        // ICT 18-NOV-2021
        public string InsertRenewalChallanDetailsBll(long EmpID, int Category, string RefNos, int ChallanAmount, string sanno, DateTime sandate, string voucherno, string hoa, string ddocode, string Type)
        {
            return _IMotorInsuranceVehicleDetailsDll.InsertRenewalChallanDetailsDll(EmpID, Category, RefNos, ChallanAmount, sanno, sandate, voucherno, hoa, ddocode, Type);
        }

        public VM_DDOVerificationDetailsMI GetRenewalChallanDetailsBll(string ChallanNo, long EmpID)
        {
            return _IMotorInsuranceVehicleDetailsDll.GetRenewalChallanDetailsDll(ChallanNo, EmpID);
        }

        public string InsertRenewalotcChallanDetailsBll(long EmpID, int Category, string RefNos, int ChallanAmount, string sanno, DateTime sandate, string voucherno, string hoa, string ddocode, string Type)
        {
            return _IMotorInsuranceVehicleDetailsDll.InsertRenewalotcChallanDetailsDll(EmpID, Category, RefNos, ChallanAmount, sanno, sandate, voucherno, hoa, ddocode, Type);
        }

        public VM_DDOVerificationDetailsMI GetotcRenewalChallanDetailsBll(string ChallanNo, long EmpID)
        {
            return _IMotorInsuranceVehicleDetailsDll.GetotcRenewalChallanDetailsDll(ChallanNo, EmpID);
        }
